          ...
          <div className={styles.searchBar + " mdl-grid"}>
              ...
              <div className="mdl-cell mdl-cell--3-col">
                ...
                <div >
                  ...
                  <button className="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast" onClick={::this.handleSubmit}><i className="icon search"/>Find Jobs</button>
                </div>
              </div>
              <div className="mdl-cell mdl-cell--3-col">
              </div>
