...
import { ProductState, ProductRecord, JobState, JobRecord, CartState, convertMapToImmutable } from '../common/constants/Types';
...
if ( window.$REDUX_STATE ) {
	...
	state.jobs = new JobState( {
		$fetched: document.location.pathname == '/',
		jobsById: convertMapToImmutable( state.jobs.jobsById, JobRecord ),
	...
	state.products = new ProductState( {
		$fetched: document.location.pathname == '/product',
