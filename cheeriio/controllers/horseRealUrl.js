...
horseRealUrlDAO.prototype.reqIndeedJobOrigin = function(url) {
...
horseRealUrlDAO.prototype.request = function(url) {
  return new Promise((resolve, reject) => {
    ...
    .open(url)
      ...
      console.log('horseman2 scrape data: ' + JSON.stringify(data));
		...
		.url(function(url){
			console.log('horseman2 url scrape page url=' + url);
      console.log('horseman2 url scrape data: ' + JSON.stringify(data));
			resolve(url);
		});
   });
}
...
module.exports = new horseRealUrlDAO();
